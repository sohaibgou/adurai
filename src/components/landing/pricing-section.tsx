        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-stretch justify-items-center md:justify-items-stretch">
          ...
          <FadeIn delay={0.2} className="w-full max-w-[420px] md:max-w-none">
            ...
            >
              ...
              <span className="inline-flex items-center gap-1.5 self-start text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full mb-5 relative" style={{ background: "rgba(255,60,172,0.08)", color: "#FF3CAC", border: "1px solid rgba(255,60,172,0.25)", letterSpacing: "0.1em" }}>
              ...
              <div className="flex items-center gap-2 mb-5 relative rounded-lg px-3 py-2" style={{ background: "rgba(255,60,172,0.06)", border: "1px solid rgba(255,60,172,0.15)" }}>
