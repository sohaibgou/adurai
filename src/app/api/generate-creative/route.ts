...
- TEXT SAFE ZONE — CRITICAL: keep ALL text, headline, subheadline and the CTA button fully inside the centered 80% of the canvas, with a clear empty margin of at least 10% on every side (top, bottom, left, right).
